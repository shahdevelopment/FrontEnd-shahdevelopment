...
<div class="topnav">
    <div>
        <a class="name" href="/">
            <p>Shah Solehria's Web Portfolio</p>
        </a>
    </div>
    <div>
        <div id="menu-bar">
...
<div class="bodymain">
    <div class="pictcont">
        <div class="shahcont">
        <h2>Dev-Ops | AWS/Azure Cloud | Security | Software</h2>
        </div>
    </div>
    <div class="secdiv">
        <h1>Abstract</h1>
        ...
        <div class="btn-shadow">
            <a href="/contactpage" class="btn">Reach Out</a>
        </div>
    </div>
</div>
<br></br>
<div class="latnew">
    ...
    <p>This website's / web application's runtime is nodeJS and it was 
...
app.get('/rivermeadow', (req, res) => {
    ...
    <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <title>Migration Engineer</title>
        <link rel="stylesheet" href="style/style.css">
    </head>
    ...
    <body>
        <div class="geoSelfie">
            <div class="geobuttonDiv">
                ...
                <br />
                <br />
                <button onclick="startCam()" id="startvideo">Turn Camera On</button>
                <br />
                <br />
                <button onclick="endCam()" id="stopvideo">Turn Camera Off</button>
                <br />
                <br />
            ...
            <div class="cameraDiv">
                ...
                <div id="cameraid">
                    <video id="video" srcObject="MediaStream"></video>
                </div>
            </div>
        </div>
    </body>
